$(function(){
    ...
    var musicImgsData = ['img/bg.jpg','img/bg1.jpg']    // 图片地址数组,'img/bg2.jpg'
    var musicNameData = ['青花瓷','无名的人'];                   // 歌曲名数组,'归去来兮'
    var artistNameData = ['史易凡/史易凡','史易凡/史易凡']            // 创作歌手数组,'花粥'
    var musicUrls=['mp3/REC1.mp3','mp3/REC2.mp3'];// 歌曲mp3数组     ,'mp3/music3.mp3'
